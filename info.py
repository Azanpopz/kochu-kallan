...
S_GROUP = environ.get('S_GROUP',"https://t.meNasraniSeries")
MAIN_CHANNEL = environ.get('MAIN_CHANNEL',"https://t.meNasraniSeries")
FILE_FORWARD = environ.get('FILE_FORWARD',"https://t.me/+pVAZHwgkG-BiNWZl")
MSG_ALRT = environ.get('MSG_ALRT', '𝑇ℎ𝑎𝑛𝑘𝑠 𝑇𝑜 𝐶𝑟𝑎𝑧𝑦 𝐷𝑒𝑣𝑒𝑙𝑜𝑝𝑒𝑟 💖')
FILE_CHANNEL = int(environ.get('FILE_CHANNEL', -1001795553245))
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', -1001467741576))
